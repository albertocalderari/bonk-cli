...
install: `pip install git+https://github.com/albertocalderari/bonk-cli.git@0.0.4`
...
usage: bonkcli [-h] {init,timeline,vatnik} ...

CLI to bonk vatniks at scale. Let's go bonking!

positional arguments:
  {init,timeline,vatnik}
    init                Init the bonker
    timeline            Search for tweets to bonk in the timeline
    vatnik              Search for tweets to bonk in the timeline
